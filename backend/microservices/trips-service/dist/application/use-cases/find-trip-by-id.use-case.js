...
exports.FindTripByIdUseCase = void 0;
const common_1 = require("@nestjs/common");
const trip_repository_1 = require("../../domain/repositories/trip.repository");
let FindTripByIdUseCase = class FindTripByIdUseCase {
    tripRepo;
...
exports.FindTripByIdUseCase = FindTripByIdUseCase;
exports.FindTripByIdUseCase = FindTripByIdUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(trip_repository_1.TRIP_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], FindTripByIdUseCase);
//# sourceMappingURL=find-trip-by-id.use-case.js.map