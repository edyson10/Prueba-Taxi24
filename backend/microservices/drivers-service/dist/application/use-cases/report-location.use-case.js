...
let ReportLocationUseCase = class ReportLocationUseCase {
    locationHttp;
    constructor(locationHttp) {
        this.locationHttp = locationHttp;
    }
    async execute(driverId, lat, lon) {
...
exports.ReportLocationUseCase = ReportLocationUseCase = __decorate([
    ...
    __metadata("design:paramtypes", [location_http_service_1.LocationHttpService])
], ReportLocationUseCase);
//# sourceMappingURL=report-location.use-case.js.map